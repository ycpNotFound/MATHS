...
python inference.py \
    --model_name_or_path /train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/PGPS/cased-cot-pretrained-type-plugin \
    --dataset_name 'PGPS' \
    --annot_file_path /train20/intern/permanent/ycpan4/code/NumberSense/V3/jsons/pgps_qa_test.json \
