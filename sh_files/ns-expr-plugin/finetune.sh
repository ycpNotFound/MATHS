...
export decoder_task='expr'
export use_plugin=True
...
export output_dir=/train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/NumberSense/swin-bert-expr-plugin
