...
python inference.py \
    --model_name_or_path /train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/GeoQA/cased-symbolic \
    --dataset_name 'GeoQA' \
    --annot_file_path /train20/intern/permanent/ycpan4/dataset/geoqa/GeoQA3/test_en.pk \
