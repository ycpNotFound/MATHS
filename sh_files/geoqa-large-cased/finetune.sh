...
export decoder_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/bert-large-cased-special
# export decoder_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/bert-base-with-location    
export output_dir=/train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/GeoQA/large-cased-cot-direct
