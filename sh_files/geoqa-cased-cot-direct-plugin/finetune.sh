...
export output_dir=/train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/GeoQA/cased-cot-direct-plugin-3

export gradient_accumulation_steps=2
export per_device_train_batch_size=2
export per_device_eval_batch_size=2
export dataloader_num_workers=4
export num_train_epochs=200
