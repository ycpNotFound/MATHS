...
python inference.py \
    --model_name_or_path /train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/UniGeoProve/cased-cot-pretrained-type \
    --dataset_name 'UniGeoProve' \
    --annot_file_path /train20/intern/permanent/ycpan4/dataset/unigeo/UniGeo/proving_test_process.pk \
