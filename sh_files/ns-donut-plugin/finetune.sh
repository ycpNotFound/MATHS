...
export dataset_name='NumberSense'
export decoder_task='cot'
export use_plugin=False
export use_lora=False
export use_type=False   

export model_name_or_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/naver-clova-ix-donut-base
export encoder_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/donut-swin-base
export decoder_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/naver-clova-ix-donut-base
# export decoder_path=/train20/intern/permanent/ycpan4/code/NumberSense/pretrained_model/bert-base-with-location    
export output_dir=/train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/NumberSense/donut-cot-plugin-2
