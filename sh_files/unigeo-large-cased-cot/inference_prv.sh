...
python inference.py \
    --model_name_or_path /train20/intern/permanent/ycpan4/code/NumberSense/V3/experiments/UniGeo/large-cased-cot-direct-2 \
    --dataset_name 'UniGeoProve' \
    --annot_file_path /train20/intern/permanent/ycpan4/dataset/unigeo/proving_test_processed.json \
