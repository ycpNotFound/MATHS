...
def math_parser(math_conditions, geom_conditions, prob_type, positions, show_center):
    ...
    if interpret_style == "holistic":
        operator_list, int_list_1, int_list_2, int_list_3, final_expression = holistic_parser(num_pos, const_value, operator_value)
        ...
        while (num_pos % analytical_part != 0) or (num_pos / analytical_part < 2):
            ...
            analytical_part = condition_2.analytical.get_value()
        operator_list, int_list_1, int_list_2, int_list_3 , final_expression= analytical_parser(num_pos, const_value, operator_value, analytical_part)
        condition_1.operator.set_value(operator_list)
        '''
    ...
    return interpret_style, analytical_mode, analytical_part, operator_list, int_list_1, int_list_2, int_list_3, pos_list, final_expression
...
def holistic_parser(num_pos, const_value, operator_value):
    ...
    while (not qualified_1) or (not qualified_2) or (not qualified_3):
        operator_list = operator_prune(num_blanks, operator_value)
        integer_list_1, qualified_1, s1 = int_generator(operator_list, const_value[0])
        integer_list_2, qualified_2, s2 = int_generator(operator_list, const_value[1])
        integer_list_3, qualified_3, s3 = int_generator(operator_list, const_value[2])
        random.shuffle(operator_value)
        final_expression = [s1, s2, s3]
    return operator_list, integer_list_1, integer_list_2, integer_list_3, final_expression
...
def analytical_parser(num_pos, const_value, operator_value, analytical_part):
    ...
    if analytical_part == 2:
        while not (qualified_1 and qualified_2 and qualified_3 and qualified_4 and qualified_5 and qualified_6):
            operator_list = operator_prune(num_blanks, operator_value)
            part_1_1, qualified_1, s1 = int_generator(operator_list, const_value[0])
            part_1_2, qualified_2, s2 = int_generator(operator_list, const_value[0])
            part_2_1, qualified_3, s3 = int_generator(operator_list, const_value[1])
            part_2_2, qualified_4, s4 = int_generator(operator_list, const_value[1])
            part_3_1, qualified_5, s5 = int_generator(operator_list, const_value[2])
            part_3_2, qualified_6, s6 = int_generator(operator_list, const_value[2])
            random.shuffle(operator_value)
            final_expression = [s1, s2, s3, s4, s5, s6]
    ...
    if analytical_part == 3:
        while not (qualified_1 and qualified_2 and qualified_3 and qualified_4 and qualified_5 and qualified_6
            ...
            part_1_1, qualified_1, s1 = int_generator(operator_list, const_value[0])
            part_1_2, qualified_2, s2 = int_generator(operator_list, const_value[0])
            part_1_3, qualified_3, s3 = int_generator(operator_list, const_value[0])
            part_2_1, qualified_4, s4 = int_generator(operator_list, const_value[1])
            part_2_2, qualified_5, s5 = int_generator(operator_list, const_value[1])
            part_2_3, qualified_6, s6 = int_generator(operator_list, const_value[1])
            part_3_1, qualified_7, s7 = int_generator(operator_list, const_value[2])
            part_3_2, qualified_8, s8 = int_generator(operator_list, const_value[2])
            part_3_3, qualified_9, s9 = int_generator(operator_list, const_value[2])
            random.shuffle(operator_value)
            final_expression = [s1, s2, s3, s4, s5, s6, s7, s8, s9]
    ...
    if analytical_part == 4:
        while not (qualified_1 and qualified_2 and qualified_3 and qualified_4 and qualified_5 and qualified_6
            ...
            part_1_2, qualified_2, s2 = int_generator(operator_list, const_value[0])
            part_1_3, qualified_3, s3 = int_generator(operator_list, const_value[0])
            part_1_4, qualified_4, s4 = int_generator(operator_list, const_value[0])
            part_2_1, qualified_5, s5 = int_generator(operator_list, const_value[1])
            part_2_2, qualified_6, s6 = int_generator(operator_list, const_value[1])
            part_2_3, qualified_7, s7 = int_generator(operator_list, const_value[1])
            part_2_4, qualified_8, s8 = int_generator(operator_list, const_value[1])
            part_3_1, qualified_9, s9 = int_generator(operator_list, const_value[2])
            part_3_2, qualified_10, s10 = int_generator(operator_list, const_value[2])
            part_3_3, qualified_11, s11 = int_generator(operator_list, const_value[2])
            part_3_4, qualified_12, s12 = int_generator(operator_list, const_value[2])
            random.shuffle(operator_value)
            final_expression = [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12]
...
def int_generator(operator_list, const_value):
    ...
    integer_list = [int(x) if type(x) != str else x for x in integer_list ]
    ...
    return integer_list, qualified, final_expression
...
def disp_num(img, int_list, pos_list, blank, font_size, show_center):
    ...
    # for bbox in bboxes:
    #     cv2.rectangle(img, bbox[0], bbox[1], 122, thickness=1)
    return answer, img, mark_position, bboxes
...
def reverse_arrange(int_list_1, int_list_2, int_list_3, mode, part):
    ...
    if mode == 2:
        if part == 2:
            list_1_1, list_1_2 = int_list_1[0: int(num/2)], int_list_1[int(num/2): num]
            list_2_1, list_2_2 = int_list_2[0: int(num/2)], int_list_2[int(num/2): num]
            list_3_1, list_3_2 = int_list_3[0: int(num/2)], int_list_3[int(num/2): num]
            ...
            list_1_1, list_1_2, list_1_3 = int_list_1[0: int(num/3)], int_list_1[int(num/3): 2*int(num/3)], int_list_1[2*int(num/3): num]
            list_2_1, list_2_2, list_2_3 = int_list_2[0: int(num/3)], int_list_2[int(num/3): 2*int(num/3)], int_list_2[2*int(num/3): num]
            list_3_1, list_3_2, list_3_3 = int_list_3[0: int(num/3)], int_list_3[int(num/3): 2*int(num/3)], int_list_3[2*int(num/3): num]
            for i in range(len(list_1_1)):
            ...
            list_1_1, list_1_2 = int_list_1[0: int(num/4)], int_list_1[int(num/4): int(num/2)]
            list_1_3, list_1_4 = int_list_1[int(num/2): 3*int(num/4)], int_list_1[3*int(num/4): num]
            list_2_1, list_2_2 = int_list_2[0: int(num/4)], int_list_2[int(num/4): int(num/2)]
            list_2_3, list_2_4 = int_list_2[int(num/2): 3*int(num/4)], int_list_2[3*int(num/4): num]
            list_3_1, list_3_2 = int_list_3[0: int(num/4)], int_list_3[int(num/4): int(num/2)]
            list_3_3, list_3_4 = int_list_3[int(num/2): 3*int(num/4)], int_list_3[3*int(num/4): num]
            for i in range(len(list_1_1)):
        ...
        new_list_1, list_1_2 = int_list_1[0: int(num/2)], int_list_1[int(num/2): num]
        new_list_2, list_2_2 = int_list_2[0: int(num/2)], int_list_2[int(num/2): num]
        new_list_3, list_3_2 = int_list_3[0: int(num/2)], int_list_3[int(num/2): num]
        if num == 8:
